    ...
    public function index(Request $request, Randomize $randomize, Datasec $libsec): Response
        {
            ...
            if ($form->isSubmitted() && $form->isValid())
            {
                ...
                $full_path = $this
                    ->urlHelper
                    ->getAbsoluteUrl($message->getUrl());
                $this
                    ->session
                    ->getFlashBag()
                    ->add('success', $full_path);
                return $this->redirectToRoute('main');
            }

            return $this->render('message/index.html.twig', ['message' => $message, 'form' => $form->createView() , ]);
        }
        /**
